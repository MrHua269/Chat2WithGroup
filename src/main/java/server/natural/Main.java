...
import server.natural.command.CommandMFG;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        try{
         ...
         saveDefaultConfig();
//         I don't understand why add this code
//         Thread.sleep(3000);
         ...
         Objects.requireNonNull(Bukkit.getPluginCommand("mfg")).setExecutor(new CommandMFG());
         Objects.requireNonNull(Bukkit.getPluginCommand("stopcs")).setExecutor(new CommandStopChatServer());
         if(tmp1){
